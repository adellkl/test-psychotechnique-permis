-- =============================================
-- SUPABASE SQL SETUP FOR PERMIS EXPERT
-- =============================================

-- Note: The JWT secret is managed by Supabase automatically
...
CREATE POLICY "Enable all access for available_slots" ON available_slots FOR ALL USING (true);
CREATE POLICY "Enable read access for email_templates" ON email_templates FOR SELECT USING (true);
...
-- Add some available slots for the next 30 days
