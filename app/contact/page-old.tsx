          ...
          >
            <div className="bg-white/70 backdrop-blur-lg rounded-xl shadow-lg border border-white/20 overflow-hidden">
              ...
              <div className="relative h-[500px] rounded-xl overflow-hidden">
                ...
                {/* Overlay avec cercle bleu pour délimiter la zone */}
                ...
                <div className="absolute inset-0 pointer-events-none">
                  ...
                  <button
                    ...
                    className="absolute top-[52%] left-[56%] transform -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-auto"
                  ...
                  <button
                    ...
                    className="absolute top-[48%] left-[48%] transform -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-auto"
