...
export const metadata: Metadata = {
  title: "Test Psychotechnique Invalidation Permis - Solde Nul Points | Clichy & Colombes 92",
  description: "Test après invalidation permis (solde nul). Centres Clichy & Colombes 92. Psychologue ADELI certifiée. 2e chance gratuite. Récupération permis. RDV 07 65 56 53 79.",
