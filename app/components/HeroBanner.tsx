...
export default function HeroBanner() {
  return (
    <section className="relative bg-white overflow-hidden min-h-screen flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 lg:py-12 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Contenu texte */}
          <div className="space-y-8 mt-8 lg:mt-0">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-2 bg-emerald-100 text-emerald-800 rounded-full text-xs sm:text-sm font-medium animate-smooth-bounce">
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg text-gray-600 leading-relaxed animate-slide-in-right animation-delay-1100">
            ...
            {/* Boutons */}
            <div className="flex flex-col sm:flex-row gap-4 animate-slide-in-left animation-delay-1600">
              <Link 
                href="tel:0765565379"
                className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-blue-600 text-white rounded-xl font-semibold text-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl animate-button-glow"
              >
                <svg className="w-5 h-5 group-hover:animate-ring" fill="currentColor" viewBox="0 0 20 20">
              ...
              <Link 
                href="/rendez-vous"
                className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-blue-600 border-2 border-blue-600 rounded-xl font-semibold text-lg hover:bg-blue-50 transition-all duration-300"
              >
            ...
            {/* Avantages */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8 animate-fade-in-up animation-delay-1900">
              <div className="flex items-center gap-3 p-4 bg-white rounded-lg shadow-sm border border-gray-100">
                ...
                <div>
                  <p className="font-medium text-gray-900">Clichy (92)</p>
                  <p className="text-sm text-gray-500">3 min du métro</p>
                </div>
              </div>
