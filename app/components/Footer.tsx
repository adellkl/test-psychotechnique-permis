              ...
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-8 border border-gray-700 shadow-2xl">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-6">
                  ...
                  <div className="text-center md:text-left">
                    ...
                    <p className="text-gray-400 text-xs mt-1">Centre agréé toutes préfectures </p>
                  </div>
                </div>

                {/* Avis Google réels avec liens */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <a
                    href="https://share.google/SunHMyFbFQzxJGOUr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-white/5 rounded-lg p-4 border border-gray-600 hover:bg-white/10 hover:border-blue-400 transition-all group"
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-xs text-gray-400">Il y a 2 mois</span>
                    </div>
                    <p className="text-gray-300 text-sm italic group-hover:text-white transition-colors line-clamp-4">"J'ai passé mon test psychotechnique récemment et je tiens à remercier la personne qui l'a fait passer. Elle est très gentille, à l'écoute, met vraiment en confiance et se montre disponible."</p>
                    <p className="text-xs text-gray-400 mt-2">— Théo Bouquet</p>
                    <p className="text-xs text-blue-400 mt-2 opacity-0 group-hover:opacity-100 transition-opacity">Voir l'avis complet →</p>
                  </a>
                  <a
                    href="https://share.google/XVg6Z5h5nj6EbXEoD"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-white/5 rounded-lg p-4 border border-gray-600 hover:bg-white/10 hover:border-blue-400 transition-all group"
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-xs text-gray-400">Il y a 3 mois</span>
                    </div>
                    <p className="text-gray-300 text-sm italic group-hover:text-white transition-colors line-clamp-4">"Ravi d'avoir effectué mes tests psychotechniques avec Mme Sebti. C'est une personne très agréable qui vous met à l'aise directement avec de bonnes explications. Je recommande fortement."</p>
                    <p className="text-xs text-gray-400 mt-2">— Scottie Kemp</p>
                    <p className="text-xs text-blue-400 mt-2 opacity-0 group-hover:opacity-100 transition-opacity">Voir l'avis complet →</p>
                  </a>
                  <a
                    href="https://share.google/ADnygNwMPK5JWc4iK"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-white/5 rounded-lg p-4 border border-gray-600 hover:bg-white/10 hover:border-blue-400 transition-all group"
                  >
                    ...
                    <p className="text-gray-300 text-sm italic group-hover:text-white transition-colors line-clamp-4">"Je recommande. RDV obtenu rapidement, les consignes sont claires et la psychologue est très aimable. Top !"</p>
                    <p className="text-xs text-gray-400 mt-2">— sr.doc1908</p>
                    <p className="text-xs text-blue-400 mt-2 opacity-0 group-hover:opacity-100 transition-opacity">Voir l'avis complet →</p>
                  </a>
                </div>
